  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Prepare GPB</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
                                          ...
                                          <div class="card-body">
                                            <table id="example1" class="table table-bordered table-striped">
                                              ...
                                              <tbody>
                                                ...
                                                <td>{{$r->GenderIssue}}</td>
                                                <td>{{$r->GADActivity}}</td>
                                                <td>{{$r->CauseOfGenderIssue}}</td>
                                                <td>{{$r->GADResultStatement_Objective}}</td>
                                                <td>{{$r->RelevantOrg_MFO_PAP_PPA}}</td>
                                                <td>{{$r->MFO_PAP_STATEMENT}}</td>
                                                <td>{{$r->GADActivity}}</td>
                                                <td>{{$r->Focused}}</td>
                                                <td>{{$r->VarianceRemarks}}</td>
      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class=" float-right"> 
            ...
            <a href="{{url('Actionsubmit/'.$headID)}}" class="btn btn-success float-right"> Submit  GAD </a>
